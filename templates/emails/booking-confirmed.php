 ...
 *
 * Available vars: $user_name, $booking_id, $teacher_name, $class_name, $booking_date, $booking_time, $amount, $site_name
 *
 * @package GMM
 */
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e5e5e5;">
		<tr>
			<td style="padding:24px;">
				...
				<p style="margin:0 0 12px;"><?php esc_html_e( 'Your booking has been confirmed.', 'gospel-music-mastery' ); ?></p>
