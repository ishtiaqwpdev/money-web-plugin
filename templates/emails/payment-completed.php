<?php
/**
 * Payment completed email template.
 *
 * Available vars: $user_name, $teacher_name, $class_name, $booking_id, $payment_id, $amount, $site_name, $admin_note
 *
 * @package GMM
 */
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e5e5e5;">
		<tr>
			<td style="padding:24px;">
				...
				<p style="margin:0 0 12px;"><?php esc_html_e( 'A payment has been completed successfully.', 'gospel-music-mastery' ); ?></p>
				<ul style="margin:0 0 12px;padding-left:18px;">
					<?php if ( ! empty( $payment_id ) ) : ?>
						<li><?php printf( /* translators: %s: payment id */ esc_html__( 'Payment ID: %s', 'gospel-music-mastery' ), esc_html( (string) $payment_id ) ); ?></li>
					<?php endif; ?>
