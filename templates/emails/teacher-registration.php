	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e5e5e5;">
		<tr>
			<td style="padding:24px;">
				...
				<p style="margin:0 0 12px;"><?php esc_html_e( 'We received your teacher application. Our team will review it and notify you once a decision is made.', 'gospel-music-mastery' ); ?></p>
